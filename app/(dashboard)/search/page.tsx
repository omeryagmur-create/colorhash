...
import { Search, Sparkles, AlertCircle, Palette } from 'lucide-react'
            ...
            <div className="container mx-auto px-4 max-w-7xl py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Find images that perfectly match your palette using advanced AI color matching
                    </p>
                </div>
                ...
                <Card className="mb-12 border-2 shadow-xl max-w-3xl mx-auto">
                    <CardHeader>
                        ...
                        <CardDescription className="text-base">
                            Input one or more HEX codes separated by spaces (e.g., #FF5733 #000000)
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        ...
                        {validColors.length > 0 && (
                            <div className="space-y-3">
                                <p className="text-sm font-medium text-gray-700">Detected Colors:</p>
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-20 space-y-4">
                        ...
                        <p className="text-lg font-medium text-gray-600">Searching for perfect matches...</p>
                    </div>
                ) : (
                        ...
                        {images.length > 0 && (
                            <div className="text-center">
                                <h2 className="text-2xl font-bold text-gray-900 mb-2">
                                    Found {images.length} Perfect Matches
                                </h2>
                                <p className="text-gray-600">Click on color swatches to copy HEX codes</p>
                            </div>
                        )}
